        ...
        <div className="login-card">
          ...
          <div className="login-left-panel">
            ...
            <img 
              ...
              style={{ width: '250px', height: '235px', maxWidth: '100%' }}
            />
            ...
            <img 
              ...
              style={{ width: '379px', height: '501px', maxWidth: '100%' }}
            />

            {/* 3. Foreground Text Content */}
            <div className="login-left-panel-content">
              <div style={{ width: '100%', textAlign: 'left' }}>
                <p className="login-brand-subtitle-top">Tagum City Health Office</p>
                <div className="login-brand">
                  <div className="login-brand-icon">
                    <svg style={{ width: '24px', height: '24px', color: '#ffffff' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L5.6 15.12a2 2 0 01-1.183-1.84V5.059a2 2 0 011.183-1.84l2.383-.477a6 6 0 013.86.517l.318.158a6 6 0 003.86.517l2.387-.477a2 2 0 011.022.547" />
                    </svg>
                  </div>
                  <h1 className="login-brand-title">Dr-LUNAS</h1>
                </div>
              </div>

              <div style={{ width: '100%', textAlign: 'center' }}>
                <p className="login-brand-tagline">
                  Providing quality healthcare to every Tagumenyo.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="login-right-panel">
            <div className="login-header">
              ...
              <p className="login-subtitle">Secure access for authorized Tagum City health personnel.</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="login-form">
              ...
              <div className="form-footer">
                ...
                <a href="/forgot-password" className="form-forgot-link">
                  Forgot password?
                </a>
              </div>

              <button type="submit" disabled={processing} className="btn-signin">
